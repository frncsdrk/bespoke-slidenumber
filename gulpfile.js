...
gulp.task('compile', ['clean'], function() {
  return browserify('./lib/bespoke-slidenumber.js')
    .bundle({ standalone: 'bespoke.plugins.slidenumber' })
    .pipe(source('bespoke-slidenumber.js'))
    .pipe(buffer())
    ...
    .pipe(gulp.dest('dist'))
    .pipe(rename('bespoke-slidenumber.min.js'))
    .pipe(uglify())
    .pipe(header(template([
      '/*! <%= name %> v<%= version %> ',
